...
<div class="admin-wrapper">
    ...
    <div class="form-card">
        ...
        <form method="POST" action="/Marrakech_Food_Lovers/admin/add_category.php" class="main-form">
            ...
            <div class="form-actions">
                ...
                <a href="/Marrakech_Food_Lovers/app/views/admin/categories.php" class="btn-cancel">Annuler</a>
            </div>
